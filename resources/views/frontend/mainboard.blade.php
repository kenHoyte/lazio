                ...
                <div class="navbar-header">
                    ...
                    <div class="d-flex">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                <div class="px-lg-2">
                                    <div class="row no-gutters">
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="dashboard-saas.html#">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-0"
                                ...
                                <div class="p-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <a href="dashboard-saas.html#!" class="small"> View All</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <!-- item-->
                                <a class="dropdown-item" href="dashboard-saas.html#"><i class="bx bx-user font-size-16 align-middle mr-1"></i> Profile</a>
                                ...
                                <a class="dropdown-item text-danger" href="dashboard-saas.html#"><i class="bx bx-power-off font-size-16 align-middle mr-1 text-danger"></i> Logout</a>
                            </div>
                        </div>
